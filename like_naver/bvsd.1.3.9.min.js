            ...
            f = (t.ERROR_PREFIX = h, function() {
                ...
                return e.flush = function() {
                    ...
                    var i = d,
                        ...
                        c = ["version:1.3.9", "location:" + a, "properties:" + s, "user-agent:" + u, "name:" + t, "message:" + n, "stack:" + r],
                        l = c.join("|");
                    try {
                        return h + o(l)
                    } catch (f) {
        ...
        ! function(t, n, r) {
            ...
            return e.prototype = {
                ...
                get_high_entropy_data: function(e, t) {
                    ...
                    t.startFunction("get_high_entropy_data"), navigator.userAgentData.getHighEntropyValues(["architecture", "model", "bitness", "platform", "platformVersion", "uaFullVersion", "fullVersionList", "wow64", "mobile"]).then(function(r) {
                        return n.highEntropyData = r, n.isApplyHighEntropy = !0, t.endFunction("get_high_entropy_data"), n.get_permission_state(e, t)
                    })["catch"](function(r) {
                        return n.isApplyHighEntropy = !1, n.functionError += "get_high_entropy_data: " + r.message.toString() + "|", t.endFunction("get_high_entropy_data"), n.get_permission_state(e, t)
                    })
                },
                get_permission_state: function(e, t) {
                    ...
                    t.startFunction("get_permission_state"), navigator.permissions.query({
                        ...
                        return Notification && Notification.permission && r && r.state && (n.permissionStateInfo = Notification.permission.toString() + "|" + r.state.toString()), t.endFunction("get_permission_state"), n.getInfo(e, t)
                    })["catch"](function(r) {
                        return n.functionError += "get_permission_state: " + r.message.toString() + "|", t.endFunction("get_permission_state"), n.getInfo(e, t)
                    })
                },
                get: function(e, t) {
